pub mod app1 {
    ...
    pub fn run() {
        println!("Starting app1...");
        
        for i in 1..=10 {
            println!("Executing step {} of app1...", i);
            thread::sleep(Duration::from_millis(500));
            execute_command(i);
        }
        
        println!("app1 execution completed.");
    }
    ...
    fn execute_command(step: usize) {
        ...
        let output = Command::new("bash")
            ...
            .arg(command)
            .output()
            .expect("Failed to execute app1 step");
    ...
    pub fn run_extended() {
        println!("Starting extended execution of app1...");
        
        for i in 1..=50 {
            println!("Executing extended step {} of app1...", i);
            thread::sleep(Duration::from_millis(300));
            execute_advanced_command(i);
        }
        
        println!("Extended execution of app1 completed.");
    }
    ...
    fn execute_advanced_command(step: usize) {
        ...
        let output = Command::new("bash")
            ...
            .arg(command)
            .output()
            .expect("Failed to execute app1 advanced step");
    ...
    pub fn stress_test() {
        println!("Starting stress test of app1...");
        ...
        println!("Stress test of app1 completed.");
    }
