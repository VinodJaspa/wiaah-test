...
export type PendingAppointmentsDataApiResponse = InferType<typeof apiRes>;
...
export const getPendingAppointmentsFetcher =
  async (): Promise<PendingAppointmentsDataApiResponse> => {
    const res: AsyncReturnType<typeof getPendingAppointmentsFetcher> = {
      data: [
        {
          type: "hotel",
          data: {
