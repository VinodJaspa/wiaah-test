...
import {
  ...
  ProductCheckoutDataValidationSchema,
} from "validation";
const senctence =
...
export type ServiceCheckoutDataType = InferType<
  typeof CheckoutDataValidationTester
>;
...
export type ProductCheckoutData = InferType<
  typeof ProductCheckoutDataValidationSchema
>;
