...
export default {
  title: "UI / Features /Social /Cards /services /SocialServiceDetailsCard",
  component: SocialServiceDetailsCard,
} as Meta<typeof SocialServiceDetailsCard>;

const template: StoryFn<typeof SocialServiceDetailsCard> = (args) => (
  <div className="w-96">
