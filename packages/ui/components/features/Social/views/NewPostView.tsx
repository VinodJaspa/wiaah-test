...
const { t }: { t: (key: string, ...args: any[]) => string } = useTranslation();
  ...
  return (
    <>
      <div className="flex items-center gap-32 px-40 py-20 rounded border border-gray-500">
        <div className="w-1/2 flex flex-col gap-4">
          <div className="w-full flex text-2xl font-bold justify-center">
            {t("Create a post")}
          </div>
          <div className="h-full w-full justify-center items-center justify-self-center flex gap-6">
            <div className="flex w-full flex-col gap-2 text-lg font-semibold">
              ...
              <div className="flex flex-col gap-1">
                ...
                <InputGroup>
                  ...
                  <InputRightElement className="px-4">
                    <HashtagIcon className="fill-gray-300 text-lg" />
                  </InputRightElement>
                </InputGroup>
              </div>
              <div className="flex flex-col gap-1">
                <p>{t("User")}</p>
                <InputGroup>
                  <Input {...inputProps("mentions")} />
                  <InputRightElement className="px-4">
                    <FiAtSign className="text-gray-300 text-lg" />
                  </InputRightElement>
                </InputGroup>
              </div>
              <div className="flex flex-col gap-1">
                ...
                <InputGroup>
                  <Input />
                  <InputRightElement>
                    <div className="fill-gray-300 text-lg px-4">
                      <GrLocationPin />
                    </div>
                  </InputRightElement>
                </InputGroup>
        ...
        <div className="w-1/2 flex flex-col justify-between items-center h-full py-8 bg-gray-100">
          {mediaType === "photo" ? (
            <div className="flex px-8 w-full flex-col gap-4">
...
const { t }: { t: (key: string, ...args: any[]) => string } = useTranslation();
  ...
  const { data: prods } = useGetProductsQuery({ pagination });
