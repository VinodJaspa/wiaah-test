...
import { useSearchShopsQuery } from "../../services";
...
export const ShopsSearchDrawer: React.FC<{}> = () => {
  ...
  const { form } = useForm<Parameters<typeof useSearchShopsQuery>[0]>({});
  const { data } = useSearchShopsQuery(form);
            ...
            return (
              ...
              >
                ...
                <Button
                  ...
                  onClick={() => {}}
                >
                  <p className="text-semibold text-sm">{t("Vist service")}</p>
