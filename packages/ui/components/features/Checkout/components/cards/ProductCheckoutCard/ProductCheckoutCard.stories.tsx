...
export default {
  title: storybookCheckoutCardsTitle + "ProductCheckoutCard",
  component: ProductCheckoutCard,
} as ComponentMeta<typeof ProductCheckoutCard>;

const template: ComponentStory<typeof ProductCheckoutCard> = (args) => (
  <ProductCheckoutCard {...args} />
);
