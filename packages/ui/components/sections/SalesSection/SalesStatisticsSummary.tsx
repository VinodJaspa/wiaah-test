...
} from "@UI/components/Sales/SalesStatisticsSummary";
...
export default function SalesSection() {
  ...
  const salesData = {
    ...
    returns: "$62,412.11",
    returnsChange: "+8%",
    attrition: "$52,471.21",       // renamed here
    attritionChange: "-3%",        // renamed here
  };
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-8 mb-20">
       {/* Title and Back Button */}
       <div className="flex items-center justify-between mb-6">
      <SectionTitle title="Sales Statistics" />
