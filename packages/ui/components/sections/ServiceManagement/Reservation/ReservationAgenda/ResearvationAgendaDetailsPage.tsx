...
import ActionButtonsReservation from "@UI/components/shadcn-components/Buttons/bookingActionButton";
import BookingActionButtons from "@UI/components/shadcn-components/comman/BookingActionButtons";
import BookingID from "@UI/components/shadcn-components/comman/bookingId";
import BookingOverview from "@UI/components/shadcn-components/comman/BookingOverview";
import BookingSummaryCard from "@UI/components/shadcn-components/comman/BookingSummary";
import CancellationPolicy from "@UI/components/shadcn-components/comman/CancellationPolicy";
import ServiceItems from "@UI/components/shadcn-components/comman/ServiceItems";
import ServiceLocation from "@UI/components/shadcn-components/comman/ServiceLocation";
import PaymentStatus from "@UI/components/shadcn-components/PaymentStatus/paymentStatus";
import QRCodeVerification from "@UI/components/shadcn-components/QrCode/qrCode";
...
export default function ResearvationDetailsPage({ setDetailPage }) {
    const mockData = {
        bookingId: "BKG123456",
        overview: {
    ...
    return (
        <main className="max-w-3xl mx-auto px-4 py-2 space-y-2 mb-8">
            {/* Page Content */}
            <div className="space-y-2">
                <BackButton onClick={() => setDetailPage(false)} />
                <SectionTitle title="My Booking Details" />
            </div>
            <BookingID id="2324567" />
