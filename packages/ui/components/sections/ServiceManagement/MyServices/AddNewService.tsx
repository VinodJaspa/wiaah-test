...
import { useGetMyShopType } from "@features/Shop";
import {
  RentalPropertyType,
  RentalTypeOfPlace,
  RestaurantDishType,
...
export const NewServiceStepper: React.FC<{
  ...
  return (
    <div className="flex flex-col gap-4 h-full justify-between">
      ...
      >
        {({ nextStep, previousStep, currentStepIdx, goToStep }) => (
          <>
            <CheckMarkStepper
                      ...
                      {showOn([ServiceType.HolidayRentals]) ? (
                        <>
                          <Select {...selectProps("propertyType")}>
                            <SelectOption
                              value={RentalPropertyType.Appertemant}
                            >
                      ...
                      stepComponent: (
                        <div className="flex flex-col gap-4 w-full">
                          ...
                          <div className="grid grid-cols-8 gap-y-2">
                            ...
                            <p className="font-semibold col-span-7">
                              {t("Every")}
                            </p>
                                ...
                                handleChange(
                                  ...
                                  v === true
                                    ? (
                                        form.adaptedFor?.filter(
                                          (e) =>
                                            e !== ServiceAdaptation.Wheelchair
                                        ) || []
