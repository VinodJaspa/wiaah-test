...
export const NewServiceStepper: React.FC<{
  ...
  sellerId: string;
}> = React.forwardRef(({ isEdit, data, sellerId, onFinish }, ref) => {
  const { t } = useTranslation();
            ...
            stepComponent: (
              <div className="w-full flex flex-col gap-4">
                ...
                {showOn([ServiceType.BeautyCenter]) ? (
                  <div className="flex flex-col gap-2">
                    ...
                    <Select {...selectProps("duration")}>
                      <SelectOption value={15}>15 {t("minutes")}</SelectOption>
                      <SelectOption value={30}>30 {t("minutes")}</SelectOption>
                      <SelectOption value={45}>45 {t("minutes")}</SelectOption>
                ...
                <div>
                  ...
                  <HashTagInput
                    {...inputProps("hashtags", undefined, undefined, (v) => v)}
                  />
                </div>
                ...
                stepComponent: (
                  <div className="flex flex-col gap-4 w-full">
                    ...
                    <div className="grid grid-cols-8 gap-y-2">
                      <p className="font-semibold col-span-1">{t("Repeat")}</p>
                  ...
                  <>
                    ...
                    <HStack className="justify-between">
                      ...
                      <Switch
                        variant="buttons"
                        checked={
                          form.restriction?.includes(ServiceRestriction.Pets) ||
                          false
                        }
                        onChange={(v) => {
                          handleChange(
                    ...
                    <>
                      ...
                      <div className="flex flex-col gap-1">
                        <Radio name={"cancelationPolicyType"}>
                          ...
                          <p>{`(${t("the client can cancel  at anytime")})`}</p>
                        </Radio>
                        <Radio name={"cancelationPolicyType"}>
