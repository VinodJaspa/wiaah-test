...
import AddOnDialog from "./Dialog/AddOnDialog";
import AddSeasonalDialog from "./Dialog/AddSeasonalDialog";
import AddExtraFeesDialog from "./Dialog/AddExtraFees";
import AddDiscountFormDialog from "./Dialog/AddDiscountDialog";
...
export default function AddRoomForm({ setAddNewRoom }) {
    const allFeatures = [
        "Free Wi-Fi",
        "Swimming Pool",
        "Fitness Center",
    ...
    return (
        <>
            ...
            />
            <AddDiscountFormDialog isOpen={isDiscountDialogOpen} onClose={() => setDiscountDialogOpen(false)} />
            <AddSeasonalDialog isOpen={isSeasonalDialogOpen} onClose={() => setSeasonalDialogOpen(false)} />
            <AddExtraFeesDialog isOpen={isExtraFeesDialogOpen} onClose={() => setExtraFeesDialogOpen(false)}
            />            <Formik
                ...
                {({ values, setFieldValue }) => (
                    <Form className="max-w-4xl mx-auto p-6 space-y-6 bg-white rounded-md shadow">
                        <SectionTitleAndButtonStack>
                            <SectionTitle title="Add New Room"></SectionTitle>
