...
export interface ChecklistProps extends HtmlDivProps {}

export const ChecklistIcon: React.FC<ChecklistProps> = (props) => {
  return (
    <span {...props}>
      <svg x="0px" y="0px" viewBox="0 0 499.996 499.996">
        <g>
          <g>
            <path
