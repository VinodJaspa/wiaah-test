...
export const SubscribeForm: FC<SubscribeFormProps> = () => {
  ...
  return (
    <Box className="block w-full space-y-4 lg:col-span-2">
      <Text
        fontWeight={"bold"}
      ...
      <Box className="flex w-4/5 items-center space-x-2 rounded-lg bg-gray-700 px-2 py-1.5 lg:w-3/4">
      ...
      <Button
        ...
        className="px-3.5 py-2 uppercase text-white"
      >
