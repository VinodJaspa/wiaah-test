...
import { ShadcnFlex, ShadcnInput, ShadcnLabel } from "@UI/components/shadcn-components";
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <ShadcnFlex className="flex flex-wrap gap-4">
        ...
        <div className="flex-1">
          <ShadcnLabel className="text-sm">Status</ShadcnLabel>
        </div>
      ...
      {/* Brand */}
      <div className="flex-1">
        <ShadcnLabel className="text-sm">Brand</ShadcnLabel>
      ...
      {/* Shipping */}
      <div className="flex-1">
        <ShadcnLabel className="text-sm">Shipping</ShadcnLabel>
      ...
      {/* Size */}
      <div className="flex-1">
        <ShadcnLabel className="text-sm">Size</ShadcnLabel>
      ...
      {/* Rating */}
      <div className="flex-1">
        <ShadcnLabel className="text-sm">Rating</ShadcnLabel>
      ...
      {/* Price Range */}
      <div className="flex-1">
        <ShadcnLabel className="text-sm">Price</ShadcnLabel>
        <FormField name="priceRange" control={control}>
          <ShadcnFlex className="gap-2 items-center">
            <div className="w-full relative">
              <ShadcnInput
                type="number"
                placeholder="Min"
                className="bg-white w-full pl-[30px] pr-[30px] border border-gray-100 rounded-[6px] focus:ring-0 text-gray-500 text-[14px] h-10"
              />
              <div className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-500">
                <PiCaretUpDownFill className="w-5 h-5 cursor-pointer" />
              </div>
            </div>
            <div className="w-full relative">
              <ShadcnInput
